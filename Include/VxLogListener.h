...
#define VXREGLOGFILEEX(name, level, flags, timeformat)                                                                      \
    {                                                                                                                       \
        VxFileListener *li = (VxFileListener *)VxLog::GetLog().RegisterListener(VxFileListener::m_Guid, name, g_LogModule); \
        if (li)                                                                                                             \
        {                                                                                                                   \
            li->SetLevel(level);                                                                                            \
            li->SetFlags(flags);                                                                                            \
            li->SetTimeFormat(timeformat);                                                                                  \
        }                                                                                                                   \
    }
...
#define VXREGLOGFILEEXV(var, name, level, flags, timeformat)                                                        \
    {                                                                                                               \
        VxFileListener *li = (VxFileListener *)VxLog::GetLog().RegisterListener(VxFileListener::m_Guid, name, var); \
        if (li)                                                                                                     \
        {                                                                                                           \
            li->SetLevel(level);                                                                                    \
            li->SetFlags(flags);                                                                                    \
...
#define VXREGLOGFILEEXV2(var, name, level, flags, timeformat, dir, ext)                                                    \
    {                                                                                                                      \
        VxFileListener *li = (VxFileListener *)VxLog::GetLog().RegisterListener(VxFileListener::m_Guid, name, vargModule); \
        if (li)                                                                                                            \
        {                                                                                                                  \
            li->SetLevel(level);                                                                                           \
            li->SetFlags(flags);                                                                                           \
...
#define VXREGLOGCONSOLEEX(level, flags, timeformat)                                                                                                \
    {                                                                                                                                              \
        VxConsoleListener *li = (VxConsoleListener *)VxLog::GetLog().RegisterListener(VxConsoleListener::m_Guid, "CONSOLE LISTENER", g_LogModule); \
        if (li)                                                                                                                                    \
        {                                                                                                                                          \
            li->SetLevel(level);                                                                                                                   \
            li->SetFlags(flags);                                                                                                                   \
...
#define VXREGLOGCONSOLEEXV(var, level, flags, timeformat)                                                                                  \
    {                                                                                                                                      \
        VxConsoleListener *li = (VxConsoleListener *)VxLog::GetLog().RegisterListener(VxConsoleListener::m_Guid, "CONSOLE LISTENER", var); \
        if (li)                                                                                                                            \
        {                                                                                                                                  \
            li->SetLevel(level);                                                                                                           \
            li->SetFlags(flags);                                                                                                           \
...
#define VXREGLOGDEBUGEX(level, flags, timeformat)                                                                                                                  \
    {                                                                                                                                                              \
        VxOutputDebugListener *li = (VxOutputDebugListener *)VxLog::GetLog().RegisterListener(VxOutputDebugListener::m_Guid, "OUTPUTDEBUG LISTENER", g_LogModule); \
        if (li)                                                                                                                                                    \
        {                                                                                                                                                          \
            li->SetLevel(level);                                                                                                                                   \
            li->SetFlags(flags);                                                                                                                                   \
...
#define VXREGLOGDEBUGEXV(var, level, flags, timeformat)                                                                                                    \
    {                                                                                                                                                      \
        VxOutputDebugListener *li = (VxOutputDebugListener *)VxLog::GetLog().RegisterListener(VxOutputDebugListener::m_Guid, "OUTPUTDEBUG LISTENER", var); \
        if (li)                                                                                                                                            \
        {                                                                                                                                                  \
            li->SetLevel(level);                                                                                                                           \
            li->SetFlags(flags);                                                                                                                           \
