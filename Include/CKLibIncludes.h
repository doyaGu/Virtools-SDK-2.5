...
inline void RegisterMP3Reader(CKPluginManager* pm);
...
void CDECL_CALL CKDX5RasterizerGetInfo(CKRasterizerInfo* Info);
void CDECL_CALL CKGLRasterizerGetInfo(CKRasterizerInfo* Info);
...
//---- MP3 Reader (1)
CKPluginInfo* CDECL_CALL CKGet_Mp3Reader_PluginInfo(int index);
CKDataReader* CDECL_CALL CKGet_Mp3Reader_Reader(int pos);
...
inline void RegisterMP3Reader(CKPluginManager* pm)
{
	pm->RegisterPluginInfo(0,CKGet_Mp3Reader_PluginInfo(0),NULL,CKGet_Mp3Reader_Reader);
	pm->RegisterNewStaticLibAsDll("Mp3 Reader",1);
}

inline void RegisterWAVReader(CKPluginManager* pm)
{
	pm->RegisterPluginInfo(0,CKGet_WavReader_PluginInfo(0),NULL,CKGet_WavReader_Reader);
	pm->RegisterNewStaticLibAsDll("Wav Reader",1);
}
...
#ifdef PSX2
	RegisterAlchemyReader(pm);
	RegisterIPUReader(pm);
#endif
