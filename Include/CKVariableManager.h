...
from it and you can also restore its default value, with the RestoreValue() function.
  ...
  an enumeration of a flagg list. This can be done by overriding the GetRepresentation()
	...
	*************************************************************************/
	...
	public:
		...
		*************************************************************************/
		...
		/************************************************************************
		Summary: This function gives the representation (ie the input format) of a variable type.
		
		Remarks:
		By default this string is NULL, saying that the format 
