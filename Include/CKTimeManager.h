...
// Internal functions 
	...
	virtual CKDWORD	GetValidFunctionsMask()	{ return CKMANAGER_FUNC_OnCKPause|
																 CKMANAGER_FUNC_OnCKPlay|
																 CKMANAGER_FUNC_OnCKReset|
																 CKMANAGER_FUNC_PostClearAll|
																 CKMANAGER_FUNC_PreProcess; }
	
	virtual int	GetFunctionPriority(CKMANAGER_FUNCTIONS Function)	{ if (Function!=CKMANAGER_FUNC_PreProcess) 
																			return DEFAULT_MANAGERFUNC_PRIORITY;
																	  else	return MAX_MANAGERFUNC_PRIORITY; }	
