...
/************************************************
Summary: Sets the sprite Antialiasing processing option

Input Arguments:
	Enable: TRUE to enable Antialiasing processing.
Return Value:
	FilteringEnabled returns TRUE if filtering test is enabled.
 Remarks:
+ When Antialias is enabled some processing has to be done when rendering the sprite.
+ This option allow to disable this processing (UV offset,....)
See Also:SetRenderOptions,VxSpriteRenderOptions,VXSPRITE_RENDEROPTIONS,
************************************************/
virtual void  DisableAAProcessing(CKBOOL Disable) CK_PURE; 

virtual CKBOOL	AAProcessingEnabled() CK_PURE;
