...
//--- Geometry
	CKMesh*				AddMesh(VirtoolsTransitionMesh* mesh,const char* Name=NULL,void* Key=NULL);
...
//--- 3D Entities
	...
	CKLight*			AddLight(BOOL Target,VXLIGHT_TYPE Type,const char* Name=NULL,void* Key=NULL);
	CKCamera*			AddCamera(BOOL Target,const char* Name=NULL,void* Key=NULL);
